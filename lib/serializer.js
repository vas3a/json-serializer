 ...
 */
var parse = function(object, opts, depth)
{
	...
	if(Array.isArray(object)){
		return object.map(function(obj){ return parse(obj, opts, depth); });
	}
	...
	if(keys.length) {
		keys
			...
			.forEach(function(key){
				return parsed[key] = parse(object[key], opts, depth);
			})
		;
	}
